...
(function (cwApi, $) {
  ...
  showPopoutContent = function(callback){
    ...
    that.processChangesAndDisplay(1, action, that.editManager.initialValues, newValues, objectName, objectId, objectTypeScriptName, function (dueDate, submitCtrlCallback) {
  ...
  engine.prototype.submitBtnClick = function (source, callback, dueDate, submitCtrlCallback){
    var changeset, $this, id, changeType, changeIndex, comment, that = this;
  ...
  engine.prototype.processChangesAndDisplay = function (source, action, sourceItem, targetItem, objectName, sourceItemId, sourceObjectTypeScriptName, submitMethod, finalCallback) {
